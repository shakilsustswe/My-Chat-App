        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(person_name) || TextUtils.isEmpty(person_email) || TextUtils.isEmpty(person_password)) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(RegisterActivity.this, "Conferm password not matching!", Toast.LENGTH_SHORT).show();
                } else {
                                                    ...
                                                    databaseReference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                progressDialog.dismiss();
                                                                Toast.makeText(RegisterActivity.this, "Error in creating a new user account", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                                }
