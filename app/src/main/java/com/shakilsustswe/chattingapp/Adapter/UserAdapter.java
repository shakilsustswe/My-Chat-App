...
import com.shakilsustswe.chattingapp.Activity.MainActivity;
import com.shakilsustswe.chattingapp.Activity.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mainActivity).inflate(R.layout.user_item_layout, parent, false);
